...
extern "C" {
    pub fn m3Error(
        ...
        i_module: IM3Module,
        i_function: IM3Function,
        i_file: *const cty::c_char,
        i_lineNum: u32,
        i_errorMessage: *const cty::c_char,
        ...
    ) -> M3Result;
}
extern "C" {
    pub fn m3Abort(message: *const cty::c_char);
}
extern "C" {
    pub fn m3_Malloc(o_ptr: *mut *mut cty::c_void, i_size: usize) -> M3Result;
}
extern "C" {
    pub fn m3_Realloc(
